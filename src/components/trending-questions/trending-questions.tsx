        ...
        <section id="trending" className="w-full py-12 md:py-20">
            <div className="container mx-auto max-w-5xl px-4 animate-fade-in-up animation-delay-400">
                <div className="mb-12 space-y-2 text-center">
                    <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl">📈 Top Trending Questions</h2>
                    <p className="text-muted-foreground">
                        Here's what other users are asking about right now.
                    </p>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    {trendingQuestions.slice(0,5).map((item, index) => (
                        <Card key={index} className="p-6 flex items-center gap-4 rounded-2xl shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all cursor-pointer">
